export default function StaysSkeleton() {
  return (
    <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(17,34,17,0.05)] p-0 overflow-hidden border border-foreground/5 animate-pulse">
        ...
        <div className="flex justify-between items-start">
            <div className="w-full">
                ...
                <div className="flex gap-1 mb-4">
                    <div className="w-14 h-6 bg-gray-100 rounded-full mr-2"></div>
                    {[1,2,3,4,5].map(i => (
